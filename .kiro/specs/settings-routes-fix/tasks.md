...
- [x] 2. Implement Currency Settings (screen + route missing)
  ...
  - [x] 2.2 Export CurrencySettingsScreen from barrel
    - Add export to `src/features/wallet/screens/settings/index.ts`
    - _Requirements: 5.2_
  - [x] 2.3 Create currency route file
    - Create `app/wallet/settings/currency.tsx`
    - Import and export `CurrencySettingsScreen`
    - _Requirements: 5.1, 5.6_

- [x] 3. Fix Switch Wallet navigation bug
  - [x] 3.1 Fix PinEntryScreen navigation path
  ...
  - [x] 3.2 Ensure main wallet deletion shows wallet selection
...
- [x] 5. Remove BGN currency option (EUR only for Bulgaria)
  - [x] 5.1 Update currency type union to remove `'bgn'`
  - [x] 5.2 Ensure currency option lists exclude BGN (CurrencySettingsScreen, settings hub display)
  - _Requirements: 5.7_
