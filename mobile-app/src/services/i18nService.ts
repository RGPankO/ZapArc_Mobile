...
const translations: Record<SupportedLanguage, TranslationSet> = {
  en: {
    ...
    settings: {
      ...
      receiveNotificationsAboutTransactions: 'Receive notifications about transactions and updates',
    },
  ...
  bg: {
    ...
    settings: {
      ...
      receiveNotificationsAboutTransactions: 'Получавайте известия за транзакции и актуализации',
    },
